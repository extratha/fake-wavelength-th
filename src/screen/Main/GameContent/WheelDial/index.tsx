      ...
      >
        ...
        >
          ...
          <div
            id="hider"
            ref={wheelWrapRef}
            className="absolute bottom-[-2px] left-0 w-full h-[5px] bg-darkBrown "
        ...
        <div
          ref={wheelControl}
          className=" w-full z-20 left-0 sm:mt-20 mx-auto"
        >
          {isClueGiver && (
            <div className="w-full  top-[50%] left-[-36%] sm:left-0 mx-auto flex justify-center z-50">
              <button
                onClick={handlePeekScreen}
                className="w-20 h-20  px-3 py-1 bg-lightYellow rounded-[300px] text-darkBrown font-medium"
              >
          ...
          >
            {(isClueGiver || isHost) && (
              <button
                ...
                className="h-10 px-3 py-1 bg-lightYellow rounded-lg max-w-40 font-medium "
              >
                สุ่มหมุนคะแนน
              </button>
            )}
            <div className="flex gap-2 items-center">
              <button
                onClick={() => rotateDial(-10)}
                className="w-10 h-10 px-3 py-1 bg-lightYellow rounded-[50px]"
              >
                -
              </button>
              <button
                onClick={() => rotateDial(-1)}
                className="w-8 h-8 px-3 py-1 bg-lightYellow rounded-[50px]"
              >
                -
              </button>
              <button
                onClick={() => rotateDial(1)}
                className="w-8 h-8 px-3 py-1 bg-lightYellow rounded-[50px] font-medium"
              >
                +
              </button>
              <button
                onClick={() => rotateDial(10)}
                className="w-10 h-10 px-3 py-1 bg-lightYellow rounded-[50px] font-medium"
              >
                +
              </button>
            </div>
